...
public class PostController : ControllerBase
{
        ...
        [FromQuery] int pageSize = 25)
    {
        try
        {
            var count = _context.Posts.AsNoTracking().Count();
        ...
        {
            return StatusCode(500, new ResultViewModel<string>("05X09 - Internal Server Error"));
        }
    }
        ...
        [FromQuery] int pageSize = 25)
    {
        ...
        {
            return StatusCode(500, new ResultViewModel<List<Category>>("05X04 - Internal server error"));
        }
    }
}